...
title: Inicie sesión en Audience Manager Admin
...
# Inicie sesión en Audience Manager Admin {#log-in-to-audience-manager-admin}
...
1. Para obtener acceso a la herramienta Audience Manager [!DNL Admin], vaya a los siguientes [!DNL URL]: [https://admin.demdex.com/](https://admin.demdex.com/).
