...
title: Inicie sesión en el administrador de Audience Manager
...
# Inicie sesión en el administrador de Audience Manager {#log-in-to-audience-manager-admin}
...
1. Para obtener acceso a la herramienta de Audience Manager [!DNL Admin], vaya a los siguientes [!DNL URL]: [https://admin.demdex.com/](https://admin.demdex.com/).
