...
Para obtener información detallada, consulte [Destinos](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/destinations.html) en la *Guía del usuario del Audience Manager*.
